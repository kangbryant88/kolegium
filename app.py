...
from models import db, Rol, Usuario, Anuncio, Bitacora, PlanificacionDefensoria, Grado, Tema, AsistenciaDiaria, AsistenciaPersonal, Representante, Estudiante, EnlaceTemporal, Incidencia, AsistenciaEstudiante, Brigada, Acta, SolicitudEnlace, SolicitudActualizacion, SolicitudDefensoria
